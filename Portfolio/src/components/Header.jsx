...
import bg from "../assets/images/bggg.jpg"
    ...
    <div className="wrapper flex justify-between items-center h-screen w-full px-20 lg:justify-center lg:px-6">
      <div className="content lg:text-center">
        <div className="btn py-3">
          <button  className=' border-2 border-[#b0aaaa] font-bold text-white bg-[linear-gradient(90deg,#b004b0,#38097a)] p-4 rounded-2xl'>Bienvenue sur mon Portfolio</button>
        </div>
        <h1 className='text-white text-5xl font-bold'>Hi! I'm Mohamed</h1>
