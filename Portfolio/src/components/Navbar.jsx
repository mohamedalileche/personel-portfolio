  ...
  return (
    <>
      <div className="navbarcon flex justify-between items-center px-20 py-6 bg-transparent z-40 text-white lg:px-6 fixed w-full">
        <h1 className="text-4xl  font-bold ">Mohamed</h1>
        ...
        >
          ...
          <div className="icon text-lg flex gap-4  lg:gap-8 lg:my-10">
            ...
            <a
              href="https://github.com/Mohamedalileche"
              target="_blank"
            >
          ...
          <div className="btn">
            <button className="border-[1px] rounded-[20px] border-white border-solid py-2 px-4 hover:bg-white hover:text-black font-bold">
              Let's Connect
            </button>
          </div>
        </nav>
